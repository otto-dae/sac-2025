...
const Footer = () => {
  return (
    <footer className=' w-full h-fit p-5 flex flex-col justify-center items-center bg-gray-50'>
       ...
       <p className=' flex flex-row items-center font-light text-xl'>MADE WITH LOVE BY <span> <Image alt='' src={logoCD}/> </span> CENTRO DE DESARROLLO | 2025</p>
    </footer>
  )
}
