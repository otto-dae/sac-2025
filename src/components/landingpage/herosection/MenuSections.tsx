...
export default function MenuSections(){
    ...
    return(
        ...
        <div className="h-fit items-start gap-3 text-lg w-fit justify-between ml-20 mt-35">
                ...
                <div className=" w-fit  justify-start items-center gap-[15px] flex transition-all duration-100 hover:scale-106">
                ...
                <div className="w-fit justify-start items-center gap-[15px] flex transition-all duration-100 hover:scale-106 ml-8 p-1.5">
