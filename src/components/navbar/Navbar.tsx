...
const Navbar: React.FC = () => {
  ...
  return (
    <>
      ...
      {/* Overlay */}
      <div 
        className={`fixed inset-0 bg-transparent backdrop-blur-xs z-50 md:hidden transition-opacity duration-300 ${isMenuOpen ? 'opacity-100' : 'opacity-0 pointer-events-none'}`}
        onClick={toggleMenu}
      ></div>
